    ...
    return (
        <div className="container-fluid add-new-side-dish">
            <div className="container-fluid addNewDish-section-one">
                ...
                <div className="addNewSideDish-fields d-flex  f-fm-OpenSans  f-s-16 f-w-600 f-sty-normal f-w-str-normal f-sty-normal line-h-normal letter-spc-normal">
                    <div className="f-fm-OpenSans m-r-20 ">
